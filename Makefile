...
core:	smpte2110_20_receiver.o smpte2110_20_frame.o smpte2110_20_packet.o
...
smpte2110-20-analyzer:	xorg-list.h smpte2110-20-analyzer.c rtp.h rfc8331.h rfc8331.c core copyright.h
	gcc $(CFLAGS) $(@).c rfc8331.c smpte2110_20_packet.c $(LDFLAGS) -o smpte2110-20-analyzer

smpte2110-40-analyzer:	xorg-list.h smpte2110-40-analyzer.c rtp.h rfc8331.h rfc8331.c core copyright.h
	gcc $(CFLAGS) $(@).c rfc8331.c smpte2110_20_packet.c $(LDFLAGS) -o smpte2110-40-analyzer
